          ...
          <ScrollReveal as="div" delay={150} className="col-span-12 lg:col-span-6">
            <div className="prose-editorial">
              <p className="drop-cap-style">
                ...
                e are three brothers and two sisters, working in Baltimore under one family name. Six divisions of unrelated work on the surface, the same standard underneath.
              </p>
            </div>
          </ScrollReveal>
