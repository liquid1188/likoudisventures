          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
            <ScrollReveal delay={0}>
              <StudioCard
                ...
                description="Oil and watercolor paintings, prints, and commissions. Bold color, soft curves, the slow rhythms of a life lived between continents. Caroline paints from her studio in Iran."
            ...
            <ScrollReveal delay={150}>
              <StudioCard
                ...
                description="Vibrant, one-of-a-kind portraits and pieces shaped around energy, color, and expression. Elena also designs the digital practice of the house."
