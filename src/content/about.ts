  ...
  family: {
    ...
    members: [
      ...
      },
      {
        ...
        bio: 'Caroline leads hospitality at Ithaca House and runs Brush & Soul Studio, one of two artist studios under The Easel. She paints in oil and watercolor. Her work hangs in several of the Ithaca House properties, where guests find original paintings rather than print reproductions. On Easel, she coordinates the artist-row alongside Elena. She handles the welcome side of the hospitality work — the notes left in each property, the local-recommendations sheets, the day-of arrival check. She works from Baltimore. She studied fashion design at the Fashion Institute of Technology.',
      ...
      },
      {
        ...
        bio: 'Elena leads creative on The Easel and runs Elena Likoudis Art, one of two artist studios under that division. She also serves as Lead Designer at The Studio, where she handles the visual identity, typography, and design-system work for client engagements. A senior user-experience designer by trade. Her painting practice runs alongside her design work — she paints in oil and contributes to collaborative pieces with Caroline, including the Marian image featured on this site. She works from Pittsburgh.',
      ...
      },
      {
        ...
        bio: 'Jake leads operations at The Workshop and handles sourcing for The Table. Operations Specialist 3rd Class Petty Officer in the United States Coast Guard, currently stationed in Michigan. The operational side of his Workshop role draws on the Coast Guard discipline of running logistics under variable conditions. For The Table, he sources from upper Midwest producers and from family contacts in the Finger Lakes country where the family was raised.',
      ...
      },
      {
        ...
        bio: 'Luke leads operations at The Table and handles sourcing for The Workshop. Operations Specialist 3rd Class Petty Officer in the United States Coast Guard, currently stationed in Massachusetts. He runs the day-to-day logistics of the pantry line — orders, fulfillment, packaging standards, the labels — and coordinates the wine-side relationships in the Finger Lakes country. For The Workshop, he sources requested objects through New England networks and through the family channels back to Greece.',
